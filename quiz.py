...
def about():
	print('''\n==========ABOUT US==========
This project has been created by Suyash Shukla.
It is a basic Python Project.
I am currently pursuing my Bachelor of Technology from CDGI college Computer Science Branch.
I am looking forward to learn more about Machine learning and Data Science.''')
